...
export default class PlaygroundSection
{
    constructor(_options)
    {
        ...
        this.y = _options.y
        this.z = _options.z
        console.log(this.x, this.y, this.z) //z is initially undefined. fix later
                                            // could be used to define the desired value for area height
                                            // might be good to just have an area height value
