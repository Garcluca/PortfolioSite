...
export default class InformationSection
{
    ...
    setLinks()
    {
        ...
        for(const _option of this.links.options)
        {
            ...
            // Create label
            item.labelMesh = new THREE.Mesh(this.links.labelGeometry, new THREE.MeshBasicMaterial({ wireframe: true, color: 0xffffff, alphaMap: _option.labelTexture, depthTest: true, depthWrite: false, transparent: true }))
    ...
    setActivities()
    {
        ...
        // Material
        this.activities.material = new THREE.MeshBasicMaterial({ wireframe: true, color: 0xffffff, alphaMap: this.activities.texture, transparent: true })
