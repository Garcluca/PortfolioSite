...
export default class Physics
{
    ...
    setMaterials()
    {
       ...
       // this.materials.items.wheel = new CANNON.Material('wheelMaterial')
        ...
        // this.materials.contacts.wheelDummy = new CANNON.ContactMaterial(this.materials.items.dummy, this.materials.items.wheel, { friction: 0.3, restitution: 0.3, contactEquationStiffness: 1000 })
                ...
                else if(shape === 'box')
                {
                    ...
                    if(_options.scale){
                        ...
                        if(_options.added){                 //if the mesh is added
                            ...
                            halfExtents = new CANNON.Vec3(((mesh.scale.x * _options.scale.x) * 0.5), (mesh.scale.y * _options.scale.y) *  0.5, (mesh.scale.z * _options.scale.z) * 0.5)
