...
export default class
{
    ...
    setReveal()
    {
        ...
        this.reveal.go = () =>
        {
            ...
            {
                TweenLite.fromTo(this.sections.intro.instructions.arrows.label.material, .5, { opacity: 0 }, { opacity: 1, delay: 0.5 })
                if(this.sections.intro.otherInstructions)
                {
                    TweenLite.fromTo(this.sections.intro.otherInstructions.label.material, 0.5, { opacity: 0 }, { opacity: 1, delay: 0.75 })
                }
            }
    ...
    setStartingScreen()               //just the beginning, tough to access, probably good for adding a staatic webpage dynamically for interaction squares. 
    {

        this.otherInstructions = {}
        this.otherInstructions.x = 16
        this.otherInstructions.y = 3
        this.otherInstructions.z = .0001
        ...
        this.otherInstructions.container.position.z = -1
    ...
    setPhysics()
    {
        ...
        //console.log(this.physics.models.container)
    }
