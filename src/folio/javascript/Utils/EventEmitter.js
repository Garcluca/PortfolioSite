export default class
{
    ...
    /**
     * Resolve names
     * /clears out anything that isn't a comma, backslash, or period
     * // replaces everything above that wasn't a period with a comma.
     */
    resolveNames(_names)
    {
        let names = _names
    ...
    /**
     * Resolve name
     * for the individual name passed in from the parameters, assuming it's not just a list 
     */
    resolveName(name)
    {
        const newName = {}
